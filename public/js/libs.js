	...
	(function ($) {
	    $.fn.sendForm = function (options) {
	        return this.each(function () {
	            ...
	            //Form send init
	            var sendInit = function sendInit() {
	            ...
	            //Succes form sending
	            var successSend = function successSend(data) {
	                if (settings.reset) {
	                    resetForm(form);
	                }
	            ...
	            var errorSend = function errorSend() {
	            ...
	            function minLength(element) {
	                console.log(element);
	                if ($(element).val().length > 5) return true;
	            }
